...
int direntv6_create(struct unix_filesystem *u, const char *entry, uint16_t mode)
{
    ...
    //correcteur : vous ne testez pas la valeur de child (si entry_cpy ne contient pas de PATH_TOKEN, strrchr renvoit NULL) (-1.5)
    ...
    *child = '\0';
    ...
    //correcteur : pourquoi ne pas avoir utilisé filev6_create pour cette partie ? Manque de modularité (-1.5)
    // Write the inode
